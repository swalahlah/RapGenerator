...
depth = 4 # depth of network. changing requires retrain
maxsyllables = 5 # max syllables per line. Does not require retraining network when changed
train_mode = False
artist = "music" # used when saving the trained model
rap_file = "new_neural_rap.txt" # file that the rap is written to
...
def rhymeindex(lyrics):
	if str(artist) + ".rhymes" in os.listdir(".") and train_mode == False:
		...
		rhyme_master_list = []
		print ("Building a list of all the rhymes")
		for i in lyrics:
...
def vectors_into_song(vectors, generated_lyrics, rhyme_list):
	print ("\n\n")	
	print ("About to write rap (this could take some time)...")
	print ("\n\n")
